...
Correlation between the three color channels are in columns in the individual photo data set (Not sure about specifics here...Josh? Quantile values?) 
```{r ind_corr_hists}
...
gcc_melt_df <- melt(gcc_df,id.vars = c(date,doy))
